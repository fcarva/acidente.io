...
Trabalho)~\citep{corseuil2026rais}, compatibilizado com a classificação
setorial da MIP-ES via tabela de tradutores CNAE\,2.0/SCN-IBGE.
...
enviesamento monotônica e efeito aproximadamente homotético sobre $a_j$.\footnote{A partir de 2021, CAT e Rais passaram a compartilhar a infraestrutura do eSocial, possibilitando linkagem por CNPJ/CNAE; o cronograma de adesão à Fase~4 (saúde e segurança do trabalho) estendeu-se de outubro de 2021 (Grupo~1, faturamento $>$ R\$~78mi) até janeiro de 2023 (setor público)~\citep[cap.~6]{corseuil2026rais}. Os dados aqui utilizados (2015) são pré-migração --- a compatibilização CAT/RAIS é feita no nível setorial CNAE/MIP.}
...
não estão capturados. Para uma análise das divergências sistemáticas
entre cobertura RAIS e PNAD-Contínua e suas implicações para a
mensuração da formalidade setorial, ver \citet[cap.~4]{corseuil2026rais}.
A análise Monte Carlo (Seção~\ref{sec:resultados})
...
\bibitem[Corseuil et al.(2026)]{corseuil2026rais}
Corseuil, C. H., Mation, L., \& Pateo, F. V. (Orgs.) (2026).
\textit{A trajetória do emprego no Brasil: 50 anos de estatísticas por meio da Rais}.
Brasília: Ipea/MTE. 208p.
